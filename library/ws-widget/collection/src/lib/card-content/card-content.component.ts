...
export class CardContentComponent extends WidgetBaseComponent
  ...
  checkContentTypeCriteria() {
    if (
      ...
      this.widgetData.contentTags.excludePrimaryCategory &&
      this.widgetData.contentTags.excludePrimaryCategory.length
    ) {
      return !this.widgetData.contentTags.excludePrimaryCategory.includes(
  ...
  get imageIcon(): string[] {
    ...
    if (
      this.widgetData.content.primaryCategory !== NsContent.EPrimaryCategory.RESOURCE
    ) {
