...
export class PickerContentComponent extends WidgetBaseComponent
  ...
  @Input() selectedContentTypes = NsContent.PLAYLIST_SUPPORTED_PRIMARY_CATEGORY
  ...
  defaultThumbnail = ''
  @Input() searchableContentTypes = NsContent.PLAYLIST_SUPPORTED_PRIMARY_CATEGORY
  @Input() appPrimaryCategoryTypes = NsContent.EPrimaryCategory
  preSelected = new Set()
  constructor(
