...
export class AppTocBannerComponent implements OnInit, OnChanges, OnDestroy {
  ...
  tocConfig: any = null
  defaultSLogo = ''
  primaryCotegory = NsContent.EPrimaryCategory
  ...
  ngOnChanges() {
    ...
    if (this.content) {
      this.resumeDataLink = viewerRouteGenerator(
        ...
        this.isResource ? undefined : this.content.primaryCategory,
        this.forPreview,
  ...
  get showButtonContainer() {
    return (
      ...
      !(this.content && this.content.primaryCategory === NsContent.EPrimaryCategory.COURSE && !this.content.artifactUrl)
    )
  }

  // get isResource() {
  //   if (this.content) {
  //     const isResource = this.content.primaryCategory === NsContent.EPrimaryCategory.RESOURCE || !this.content.children.length
  //     if (isResource) {
  ...
  get isResource() {
    if (this.content) {
      const isResource = this.content.primaryCategory === NsContent.EPrimaryCategory.RESOURCE
        || this.content.primaryCategory === NsContent.EPrimaryCategory.ASSESSMENT
