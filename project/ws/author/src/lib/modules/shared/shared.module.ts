...
import { ImageCropModule, PipeOrderByModule, PipeNicRelativeModule } from '@ws-widget/utils/src/public-api'
...
import { ContentLiveEditDialogComponent } from './components/content-live-edit-dialog/content-live-edit-dialog.component'
import { ViewReviewCommentDialogComponent } from './components/view-review-comment-dialog/view-review-comment-dialog.component'
...
@NgModule({
  declarations: [
    ...
    ViewReviewCommentDialogComponent,
    ...
    ContentLiveEditDialogComponent,
  ],
  imports: [
    CommonModule,
    MatIconModule,
