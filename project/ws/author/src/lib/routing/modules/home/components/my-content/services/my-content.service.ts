...
export class MyContentService {
  ...
  getListOfUsersApi(requestPayload: NSApiRequest.ISearchUser) {
  ...
  createNewUserApi(requestPayload: NSApiRequest.ICreateNewUser) {
    return this.apiService.post<null>(
      CREATE_USER,
      requestPayload,
    )
  ...
  getExistingUserData(userId: string) {
    return this.apiService.get<any>(
      `${GET_USER_BY_ID}${userId}`
    )
  }

  assignUserRoleApi(requestPayload: NSApiRequest.IAssignUserRoles) {
    return this.apiService.post<null>(
      ADD_ROLE_TO_USER,
      requestPayload,
    )
  ...
  unblockUserApi(requestPayload: NSApiRequest.IBlockOrUnblockUser) {
    return this.apiService.post<null>(
      UNBLOCK_USER,
      requestPayload,
    )
  ...
  blockUserApi(requestPayload: NSApiRequest.IBlockOrUnblockUser) {
    return this.apiService.post<null>(
      BLOCK_USER,
      requestPayload,
    )
